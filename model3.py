...
file_names = []
measurements = []
flip = [] # 1 - Original / 2 - Original flipped / 3 - Original augmented / 4 - Original flipped augmented
...
aditional_flip = [] # 1 - Original / 2 - Original flipped / 3 - Original augmented / 4 - Original flipped augmented
...
fnames_train, fnames_valid, meas_train, meas_valid, fl_train, fl_valid = train_test_split(file_names, measurements, flip, test_size = 0.20, random_state = 100) 
...
def generator_train(file_names, measurements, flip, batch_size):
    current_path = filename_train_path
...
def generator_valid(file_names, measurements, flip, batch_size):
    current_path = filename_train_path
    num_samples = len(file_names)
    while 1: # Loop forever so the generator never terminates
...
train_generator = generator_train(file_names, measurements, flip, batch_size=256)
validation_generator = generator_train(file_names, measurements, flip, batch_size=256)
